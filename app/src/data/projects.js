...
export const projectList = [
    {
        name: 'Alley Palooza - Citywide Alleyway Restoration Contract',
        tags: ['construction', 'engineering', 'program'],
        summary: {
            paragraphs: [
    ...
    },
    {
        ...
        tags: ['infrastructure', 'construction', 'engineering'],
        summary: {
            list: [
    ...
    },
    {
        ...
        tags: ['infrastructure', 'construction', 'engineering', 'program'],
        summary: {
            paragraphs: [
    ...
    {
        name: 'Kalmia Culvert Reconstruction Project',
    ...
    },
    {
        ...
        tags: ['construction', 'design', 'program'],
        summary: {
            paragraphs: [
        ...
        details: {
            paragraphs: [
                'J-Dos as the prime consultant is providing Program Management Services which include engineering designs and supervision of works for the construction of the new road and associated structures.',
    ...
    {
        name: 'New York Avenue Bridge Project',
        tags: ['infrastructure', 'construction', 'engineering', 'program'],
        summary: {
            paragraphs: [
    ...
    },
    {
        ...
        tags: ['infrastructure', 'engineering', 'program'],
        summary: {
            paragraphs: [
    ...
    {
        name: 'Local Paving Restoration – Citywide',
        tags: ['infrastructure', 'construction', 'engineering', 'program'],
        summary: {
            paragraphs: [
